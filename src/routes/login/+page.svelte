...
<div class="flex items-center justify-center h-full">
	<form bind:this={loginForm}>
		...
		<div class="card bg-opacity-1 p-8 mr-4">
			<h2 class="text-3xl label mb-8">LOG IN</h2>
			...
			<button class="button mt-4 bg-gray-600 hover:bg-gray-900 text-white font-bold py-2 px-4" on:click="{signup}">Register</button>
